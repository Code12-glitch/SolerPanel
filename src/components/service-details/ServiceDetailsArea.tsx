    ...
    return (
      <div className="blog-details-list">
        <ul>
          {items.map((item: string, i: number) => (
            <li key={i}>
              <i className="bi bi-check2-circle"></i> {renderFeatureItem(item)}
            </li>
          ))}
        </ul>
      </div>
            ...
            <div className="col-lg-8 col-md-12">
              ...
              {sm_des_3 || (feature_list && feature_list.length > 0) ? (
                <>
                  ...
                  {feature_list &&
                    ...
                    renderFeatureList(feature_list, isCommercialPage)}
                  {sm_des_before_title_3 && (
                    <div className="service-details-discription">
              ...
              {title_3 && (
                <>
                  ...
                  {feature_list_2 &&
                    feature_list_2.length > 0 &&
                    renderFeatureList(feature_list_2)}
                  {sm_des_5 && (
                    <div className="service-details-discription">
                      <p>{sm_des_5}</p>
                    </div>
              ...
              {title_4 && (
                <>
                  ...
                  {feature_list_3 &&
                    feature_list_3.length > 0 &&
                    renderFeatureList(feature_list_3)}
              ...
              <div className="service-details-title mt-4">
                <h4>
                  {title_6 || (feature_list_4 ? "FAQ" : title_5 || "FAQ")}
                </h4>
              </div>
              <Accordion data={faq} />
            </div>
              ...
              <div className="widget-help-box">
                <div className="widget-content">
                  ...
                  <div className="widget-info-social-link">
                    <ul>
                      <li>
                        <a href="tel:1800 979 707">
                          <i className="bi bi-telephone"></i>{" "}
                          <span>{phone}</span>
                        </a>
                      </li>
                      <li>
                        <a href="mailto:info@solpoweraustralia.com.au">
