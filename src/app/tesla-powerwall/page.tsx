            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 col-md-6">
                <div className="battery-details-content">
                  ...
                  <p>
                    With the release of the first-generation Powerwall almost 7
                    years ago Tesla Energy made a big impact in the solar world
                    and pushed home energy storage into the mainstream. Released
                    in 2016, the current Powerwall 2has been designed to be more
                    compact, easier to handle, and simpler to install than the
                    first Powerwall.
                  </p>
                  <h3>Features:</h3>
                  <div class="blog-details-list">
                    <ul>
                      <li>
                        <i class="bi bi-check2-circle"></i> AC-Coupled Battery
                        System with Lithium-Ion Battery Pack
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>13.5kWh Storage
                        Capacity
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>10-year Warranty
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>Automatic, Virtual
                        System Updates
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>Child & Pet Friendly,
                        with No Wires or Hot Vents
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>Quiet Operation
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>Can be Retrofitted to
                        Your Existing Solar System
                      </li>
                      <li>
                        <i class="bi bi-check2-circle"></i>Easily Stackable for
                        System Flexibility.
                      </li>
                    </ul>
                  </div>
