const battery_data = [
  {
    id: 1,
    image: "/assets/images/battery/TESLA-POWERSHELL.webp",
  ...
  {
    id: 2,
    image: "/assets/images/battery/BYD.webp",
    title: "BYD",
    description:
      "Founded in 1995, Build Your Dreams (BYD) is a pioneer in battery technology. The BYD company, based in Shenzhen China, is focused on four different industry sectors..",
    link: "/byd",
  },
  ...
  {
    id: 4,
    image: "/assets/images/battery/ALPHAESS.webp",
    title: "Alpha-ESS",
    description:
